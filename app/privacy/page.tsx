          ...
          <div className="prose prose-lg max-w-none">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 md:p-12">
              ...
              <div className="space-y-8">
                  ...
                  <div className="space-y-4">                    <div className="bg-blue-50 rounded-lg p-4 border-l-4 border-blue-500">
                  ...
                  </p>                  <ul className="space-y-2 text-gray-700">
                  ...
                  </p>                  <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                    <a
