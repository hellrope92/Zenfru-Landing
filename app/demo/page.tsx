...
import { Phone, PhoneOff, XCircle, ArrowLeft } from 'lucide-react';
...
// A persistent button to go back home
const BackHomeButton = () => (
  <Link
    href="/"
    className="fixed top-6 left-6 flex items-center gap-2 text-slate-500 hover:text-slate-800 transition-colors duration-200 z-50 bg-white/90 backdrop-blur-sm rounded-lg px-4 py-3 shadow-lg border border-slate-200 mt-16 hover:bg-white"
  >
...
export default function DemoPage() {
  ...
  }, [demoTimer, transcription, phase, isTimerRunning, currentDialogue, nextDialogueIndex]);

  // Auto-scroll to new dialogue
  useEffect(() => {
  ...
  return (
    <section className="min-h-screen bg-sky-100 text-slate-800 flex flex-col relative mt-12">
      {/* Top bar with back home and online indicator */}
                    ...
                    <div className="bg-white/70 border border-indigo-200 rounded-2xl p-4 max-w-lg shadow-lg relative overflow-hidden">
                      ...
                      <div className="relative z-10">
                        <div className="flex items-center justify-center gap-2 mb-3">
                          <div className="w-6 h-6 bg-gradient-to-r from-indigo-400 to-purple-400 rounded-full flex items-center justify-center opacity-70">
