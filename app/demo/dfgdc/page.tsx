...
export default function DfgdcPage() {
  return (
              ...
              <div className="relative">
                <div className="text-center mb-6">
                  <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-green-100 to-emerald-100 text-green-700 px-4 py-2 rounded-full text-sm font-bold mb-4 border border-green-200">
                    ...
                    <span>Dental Clinic Demo</span>
                  </div>
                  <h3 className="text-3xl font-black mb-3 bg-gradient-to-r from-slate-900 to-slate-700 bg-clip-text text-transparent">
                    Try Our Dental AI Receptionist
                  </h3>
                  <p className="text-slate-600 font-medium">
                    See how patients can book, reschedule, and get answers about your clinic 24/7.
                  </p>
                  <p className="text-slate-500 text-sm mt-2">
                    Tap the floating assistant in the corner and speak as if you&apos;re a real patient.
                  </p>
                </div>
                ...
                <div
                  dangerouslySetInnerHTML={{
                    __html:
                      '<elevenlabs-convai agent-id="agent_1501kf530v6dezabc21qb0a1cj89"></elevenlabs-convai>',
                  }}
                />
                  ...
                  <div className="space-y-3">
                    <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl p-4 border-l-4 border-purple-500 hover:shadow-md transition-shadow">
                      <div className="text-sm font-bold text-slate-800">
                        "I&apos;m a new patient and need a cleaning next week. What&apos;s available?"
                      </div>
                      <div className="text-xs text-slate-600 mt-1 font-medium">
                        → Books new-patient cleaning and collects key details.
                      </div>
                    </div>
                    <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-4 border-l-4 border-blue-500 hover:shadow-md transition-shadow">
                      <div className="text-sm font-bold text-slate-800">
                        "I&apos;ve got tooth pain tonight. What should I do and when can I come in?"
                      </div>
                      <div className="text-xs text-slate-600 mt-1 font-medium">
                        → Guides urgent cases and finds the earliest appointment.
                      </div>
                    </div>
                    <div className="bg-gradient-to-r from-emerald-50 to-green-50 rounded-xl p-4 border-l-4 border-emerald-500 hover:shadow-md transition-shadow">
                      <div className="text-sm font-bold text-slate-800">
                        "Do you take Delta Dental and how much is whitening?"
                      </div>
                      <div className="text-xs text-slate-600 mt-1 font-medium">
                        → Answers insurance, pricing, and cosmetic dentistry questions.
                      </div>
                    </div>
                  </div>
                </div>
