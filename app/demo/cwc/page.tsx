              ...
              <div className="relative">
                ...
                <div
                  dangerouslySetInnerHTML={{
                    __html:
                      '<elevenlabs-convai agent-id="agent_2101ke22hnjffqq83rvm95tsnz54"></elevenlabs-convai>',
                  }}
                />
                  ...
                  <div className="space-y-3">
                    <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl p-4 border-l-4 border-purple-500 hover:shadow-md transition-shadow">
                      <div className="text-sm font-bold text-slate-800">
                        "I&apos;d like to book a full-service wash for tomorrow"
                      </div>
                      <div className="text-xs text-slate-600 mt-1 font-medium">
                        Collects vehicle details, suggests packages, and books the right time slot
                      </div>
                    </div>
                    <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-4 border-l-4 border-blue-500 hover:shadow-md transition-shadow">
                      <div className="text-sm font-bold text-slate-800">
                        "Can I reschedule my membership wash?"
                      </div>
                      <div className="text-xs text-slate-600 mt-1 font-medium">
                        Finds new time options, updates the schedule, and confirms instantly
                      </div>
                    </div>
                    <div className="bg-gradient-to-r from-emerald-50 to-green-50 rounded-xl p-4 border-l-4 border-emerald-500 hover:shadow-md transition-shadow">
                      <div className="text-sm font-bold text-slate-800">
                        "What are your wash packages, prices, and hours?"
                      </div>
                      <div className="text-xs text-slate-600 mt-1 font-medium">
                        Explains package options, pricing, and directions to your location
                      </div>
                    </div>
                  </div>
                </div>
