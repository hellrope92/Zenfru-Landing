              ...
              <div className="relative">
                <div className="text-center mb-6">
                  ...
                  <p className="text-slate-600 font-medium">
                    See how callers get instant support for heating and cooling issues
                  </p>
                </div>
                ...
                <div
                  dangerouslySetInnerHTML={{
                    __html:
                      '<elevenlabs-convai agent-id="agent_9601kdqmpqrxf88bdh7htcbgj9ht"></elevenlabs-convai>',
                  }}
                />
                  ...
                  <div className="space-y-3">
                    <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl p-4 border-l-4 border-purple-500 hover:shadow-md transition-shadow">
                      <div className="text-sm font-bold text-slate-800">
                        "I need my furnace repaired next week"
                      </div>
                      <div className="text-xs text-slate-600 mt-1 font-medium">
                        Screens urgency, collects details, and books the right technician
                      </div>
                    </div>
                    <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-4 border-l-4 border-blue-500 hover:shadow-md transition-shadow">
                      <div className="text-sm font-bold text-slate-800">
                        "Can I reschedule my AC repair booking tomorrow?"
                      </div>
                      <div className="text-xs text-slate-600 mt-1 font-medium">
                        Finds new time slots and confirms the change
                      </div>
                    </div>
                    <div className="bg-gradient-to-r from-emerald-50 to-green-50 rounded-xl p-4 border-l-4 border-emerald-500 hover:shadow-md transition-shadow">
                      ...
                      <div className="text-xs text-slate-600 mt-1 font-medium">
                        Shares accurate service hours, coverage, and next steps
                      </div>
                    </div>
                  </div>
                </div>
